 ...
 */
package inaka.com.mangosta.xmpp.muclight.providers;
...
public class MUCLightConfigurationsChangeProvider extends ExtensionElementProvider<MUCLightElements.ConfigurationsChangeExtension> {
    ...
    @Override
    public MUCLightElements.ConfigurationsChangeExtension parse(XmlPullParser parser, int initialDepth) throws Exception {
        ...
        return new MUCLightElements.ConfigurationsChangeExtension(prevVersion, version, roomName, subject, customConfigs);
    }
