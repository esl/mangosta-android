 ...
 */
package inaka.com.mangosta.xmpp.mam.elements;
...
public class MamPrefsIQ extends IQ {
    ...
    protected IQChildElementXmlStringBuilder getIQChildElementBuilder(IQChildElementXmlStringBuilder xml) {
        ...
        if (alwaysJids != null) {
            MamElements.AlwaysJidListElement alwaysElement = new MamElements.AlwaysJidListElement(alwaysJids);
            xml.element(alwaysElement);
        }

        if (neverJids != null) {
            MamElements.NeverJidListElement neverElement = new MamElements.NeverJidListElement(neverJids);
