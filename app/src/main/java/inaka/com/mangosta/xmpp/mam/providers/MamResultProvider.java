 ...
 */
package inaka.com.mangosta.xmpp.mam.providers;
...
public class MamResultProvider extends ExtensionElementProvider<MamElements.MamResultExtension> {
    ...
    @Override
    public MamElements.MamResultExtension parse(XmlPullParser parser, int initialDepth) throws Exception {
        ...
        return new MamElements.MamResultExtension(queryId, id, forwarded);
    }
