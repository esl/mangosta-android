...
public class MUCLightAffiliationsChangeProvider extends ExtensionElementProvider<MUCLightElements.AffiliationsChangeExtension> {
    ...
    @Override
    public MUCLightElements.AffiliationsChangeExtension parse(XmlPullParser parser, int initialDepth) throws Exception {
        ...
        return new MUCLightElements.AffiliationsChangeExtension(affiliations, prevVersion, version);
    }
